...
* [ ] Are you running the latest v2 release? The list of releases is [here](https://github.com/matthewtolman/urfave-cli/releases).
* [ ] Did you check the manual for your release? The v2 manual is [here](https://github.com/matthewtolman/urfave-cli/blob/main/docs/v2/manual.md).
